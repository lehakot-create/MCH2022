...
class Company(models.Model):
    ...
    Categories = ArrayField(base_field=models.CharField(max_length=128),
                            null=True, blank=True, verbose_name='Категории')
    Products = ArrayField(base_field=models.CharField(max_length=128),
                          null=True, blank=True, verbose_name='Продукты')
    Status = models.CharField(max_length=128, verbose_name='Статус',
                              default='Действующая организация')
    ...
    Entity = models.CharField(max_length=128, null=True, blank=True,
                              verbose_name='Год образования')
    Employ_number = models.IntegerField(null=True, blank=True,
                                        verbose_name='Количество сотрудников')
    Region = models.CharField(max_length=128, null=True,
                              verbose_name='Регион', blank=True)
    ...
    Post = models.CharField(max_length=128, null=True, blank=True,
    ...
    Catalogs = ArrayField(models.CharField(max_length=128,
                                           null=True, blank=True),
                          blank=True, verbose_name='Каталоги', null=True)
