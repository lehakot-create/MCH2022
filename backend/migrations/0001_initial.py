# Generated by Django 4.0.6 on 2022-08-08 17:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_company', models.IntegerField(unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('US', 'Пользователь'), ('MA', 'Производитель')], default='US', max_length=2)),
        ...
        migrations.AddField(
            model_name='company',
            name='user',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='companies', to='backend.profile', verbose_name='user'),
        ),
    ]
